...
<head>
	...
	<head>
	<title><cms:property name="Title" file="search" default="" /></title>
	...
	<!-- Favicon -->   
	<link href="<cms:link>%(link.weak:/system/modules/dev.jgregorio.marketplace/resources/images/favicon.ico)</cms:link>" rel="shortcut icon"/>
	...
	<link rel="stylesheet" href="<cms:link>%(link.weak:/system/modules/dev.jgregorio.marketplace/resources/css/owl.carousel.css)</cms:link>"/>
	<link rel="stylesheet" href="<cms:link>%(link.weak:/system/modules/dev.jgregorio.marketplace/resources/css/style.css)</cms:link>"/>
...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-3">
					<div class="site-logo">
						<img src="<cms:link>%(link.weak:/system/modules/dev.jgregorio.marketplace/resources/images/logo.png)</cms:link>" alt="">
					</div>
	...
	<!-- Hero section -->
	<section class="hero-section set-bg" data-setbg="<cms:link>%(link.weak:/system/modules/dev.jgregorio.marketplace/resources/images/bg.jpg)</cms:link>">
		<div class="container">
